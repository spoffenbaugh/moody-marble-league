...
const teams = [
  ...
  { name: "Sam's Senior Sitizens",logo:'/images/teams/sams-senior-sitizens.png',color: '#475569', division: 'Pacific Coast',  owner: 'Sam',  seasons: 6, average: '10.67', championships: 0 },
  ...
  { name: 'Sin',                 logo: '/images/teams/sin.png',                 color: '#0f0f0f', division: 'South Central',  owner: 'Joel', seasons: 6, average: '8.00',  championships: 0 },
  { name: 'Sorbetbes',           logo: '/images/teams/sorbetbes.png',           color: '#EA580C', division: 'Rocky Mountains',owner: 'Jeff', seasons: 6, average: '8.67',  championships: 1 },
  ...
  { name: 'Trinitarians',        logo: '/images/teams/trinitarians.png',        color: '#D97706', division: 'New England',    owner: 'Joel', seasons: 6, average: '5.50',  championships: 0 },
  ...
  { name: 'Vanilla Thunder',     logo: '/images/teams/vanilla-thunder.png',     color: '#CA8A04', division: 'Great Lakes',    owner: 'Joel', seasons: 6, average: '13.67', championships: 0 },
  ...
  { name: 'Yellow Fever',        logo: '/images/teams/yellow-fever.png',        color: '#CA8A04', division: 'South East',     owner: 'Jeff', seasons: 6, average: '16.50', championships: 0 },
            ...
            {activeDivisions.map((division) => (
              <button
                ...
                style={{
                  ...
                  textTransform: 'uppercase',
                  color: activeDiv === division ? '#fff' : 'rgba(255,255,255,0.45)',
        ...
        {DIVISION_ORDER.map((division) => {
          ...
          return (
            ...
            >
              ...
              <div>
                {divTeams.map((team) => (
                  <TeamBanner key={team.name} team={team} />
                ))}
              </div>
            </div>
          )
